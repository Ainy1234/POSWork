<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SalesInvoice.aspx.cs" Inherits="POSWork.Admin.SalesInvoice" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
               ...
               <div class="col-xs-3">
                   ...
                   <asp:TextBox ID="tbquantity" runat="server"  TextMode="Number" class="form-control"></asp:TextBox>
                                    <span class="help-block">
                                        <asp:Label ID="rQ" class="control-label col-md bold Italic"  runat="server" Text="Remaing Quantities:"></asp:Label>
                                        <asp:Label ID="remaingQuantities" class="control-label col-md bold Italic"  runat="server" Text=""></asp:Label>
                                    </span>
               </div>
               <div class="col-xs-3">
            ...
            <div class="row">
               <div class="col-xs-12">
                  ...
                  <div class="portlet-title">
                   ...
                   <asp:GridView ID="GridViewinvoice" class="table-responsive table table-bordered " AutoGenerateDeleteButton="true" 
        OnRowDeleting="GridViewinvoice_RowDeleting" EnableViewState="true" runat="server"  >
        <Columns> </Columns>
    </asp:GridView>
 ...
 <asp:Label ID="Discount" runat="server" Text="Discount(%):"></asp:Label>
                 <asp:TextBox ID="tbDiscount" OnTextChanged="tbDiscount_TextChanged" AutoPostBack="true" runat="server" TextMode="Number" class="form-control"></asp:TextBox> 
                   </div>
            ...
            <asp:Label ID="ChangebackAmount" runat="server" Text="ChangebackAmount:"></asp:Label>
               ...
               <div class="col-xs-3">
            <asp:Label ID="Customer" class="control-label" required="" runat="server" Text="Customer"></asp:Label>
                             
                                  <asp:DropDownList ID="DDCustomer"    runat="server" class="form-control" AppendDataBoundItems="true" >
