<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListPurchase.aspx.cs" Inherits="POSWork.Admin.ListPurchase" %>
     ...
     <div class="row">
            <div class="col-md-12">
              ...
              <li>
                  ...
                  <li>
                     <a href="Employees.aspx">Purchases</a>
                     <i class="icon-angle-right"></i>
                  </li>
                  <li><a href="ListEmployees.aspx">List of Purchases</a></li>
               </ul>
...
<div class="portlet box blue">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-cogs"></i>List of Purchases</div>
                     <div class="tools">
    ...
    <asp:GridView ID="GVPurchases" AutoGenerateColumns="false"
    ...
    <asp:TemplateField HeaderText="PurchaseOrderId" Visible="false"  >
        <ItemTemplate >
            <asp:Label ID="PurchaseOrderId" runat="server" Text='<%# Eval("PurchaseOrderId") %>'></asp:Label>
        </ItemTemplate>
        <%--<EditItemTemplate>
        ...
        <ItemTemplate>
            <asp:LinkButton runat="server" ID="deletebtn"    class="btn red" CommandName="Delete_Order" CommandArgument='<%#Eval("PurchaseOrderId") %>'>Delete</asp:LinkButton>
        </ItemTemplate>
                </asp:TemplateField>
               <%-- <asp:TemplateField HeaderText="Edit" >
        <ItemTemplate>
            <asp:LinkButton runat="server" ID="EditButton"    class="btn green" CommandName="Edit_Order" CommandArgument='<%#Eval("PurchaseOrderId") %>'>Edit</asp:LinkButton>
        </ItemTemplate>
