<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListPurchaseInvoice.aspx.cs" Inherits="POSWork.Admin.ListPurchaseInvoice" %>
    ...
    <div class="row">
            <div class="col-md-12">
              ...
              <li>
                  ...
                  <li><a href="ListEmployees.aspx">List of total Purchase</a></li>
               </ul>
...
<div class="portlet box blue">
    ...
    <asp:GridView ID="GVPurchaseInvoice" AutoGenerateColumns="false"
           OnRowCommand="GVPurchaseInvoice_RowCommand"
         DataKeyNames="PurchaseInvoiceId"
         OnRowDataBound="GVPurchaseInvoice_RowDataBound"
        runat="server" class="table-responsive table table-bordered ">
        <Columns>
    <asp:TemplateField HeaderText="Invoice No."  >
        <ItemTemplate >
            <asp:HyperLink ID="LBPurchaseInvoiceId" runat="server" Text='<%# Eval("PurchaseInvoiceId") %>' ></asp:HyperLink>
        ...
        <ItemTemplate>
            <asp:Label ID="Supplier" runat="server" Text='<%# Eval("SupplierId") %>'></asp:Label>
        </ItemTemplate>
        ...
        <ItemTemplate>
            <asp:LinkButton runat="server" ID="PrintInvoice"  Font-Size="Small" Height="30" Width="70"
                class="btn green " CommandName="PrintInvoice" CommandArgument='<%#Eval("PurchaseInvoiceId") %>'>Print</asp:LinkButton>
        </ItemTemplate>
                </asp:TemplateField>
